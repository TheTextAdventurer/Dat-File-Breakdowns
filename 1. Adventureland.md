...
*Conditions*
```
item '\*Pot of RUBIES\*(index:2)' carried
```
*Actions*
```
...
*Conditions*
```
item 'Lit brass lamp(index:9)' carried
```
*Actions*
```
...
*Conditions*
```
item 'Old fashioned brass lamp(index:10)' carried
```
*Actions*
```
...
*Conditions*
```
item '\*GOLDEN NET\*(index:19)' carried
```
*Actions*
```
...
*Conditions*
```
item 'Patches of `OILY` slime(index:22)' carried
```
*Actions*
```
...
*Conditions*
```
item '\*GOLD CROWN\*(index:37)' carried
```
*Actions*
```
...
*Conditions*
```
item 'Broken glass(index:41)' carried
```
*Actions*
```
drops item 'Broken glass(index:41)' into current room
...
*Conditions*
```
item '\*DRAGON EGGS\* \(very rare\)(index:44)' carried
```
*Actions*
```
drops item '*DRAGON EGGS* (very rare)(index:44)' into current room
...
*Conditions*
```
item '\*Small statue of a BLUE OX\*(index:47)' carried
```
*Actions*
```
...
*Conditions*
```
item '\*DIAMOND RING\*(index:48)' carried
```
*Actions*
```
drops item '*DIAMOND RING*(index:48)' into current room
...
*Conditions*
```
item '\*DIAMOND BRACELET\*(index:49)' carried
```
*Actions*
```
drops item '*DIAMOND BRACELET*(index:49)' into current room
...
*Conditions*
```
item 'Dead fish(index:55)' carried
```
*Actions*
```
...
*Conditions*
```
item '\*FIRESTONE\* \(cold now\)(index:56)' carried
```
*Actions*
```
...
*Conditions*
```
item 'Muddy worthless old rug(index:61)' carried
```
*Actions*
```
...
*Conditions*
```
item 'Large outdoor Advertisement(index:62)' carried
```
*Actions*
```
...
| 4| \-HOLLOW\- stump and remains of a felled tree| | 1 |
| 5| Cypress tree| | 0 |
| 6| Water| | 10 |
| 7| Evil smelling mud| MUD| 1 |
| 8| \*GOLDEN FISH\*| FIS| 10 |
| 9| Lit brass lamp| LAM| 0 |
| 10| Old fashioned brass lamp| LAM| -1 |
| 11| Rusty axe \(Magic word `BUNYON` on it\)| AXE| -1 |
| 12| Water in bottle| BOT| 3 |
| 13| Empty bottle| BOT| 0 |
| 14| Ring of skeleton keys| KEY| -1 |
...
| 62| Large outdoor Advertisement| ADV| 30 |
| 63| Hole| | 29 |
| 64| | | 0 |
| 65| | | 0 |